...
export function useThemeStore() {
  ...
  const initTheme = async () => {
    ...
    try {
      ...
      // IPC response format: { success: true, data: <theme_value> }
      if (response.success && response.data !== undefined) {
        const serverTheme = response.data
        ...
        console.warn('Unexpected theme response format, using localStorage theme:', response)
      }
    } catch (error) {
